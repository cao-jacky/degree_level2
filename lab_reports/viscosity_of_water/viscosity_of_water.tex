...
\section{Method} 
\vspace{-2ex}
A flow of water was created by fixing a capillary tube to a water tank, the tank was then filled up with water from 2cm to 16cm at 2cm intervals, this height was measured with the markings on the side of the tank. We had to ensure that we did not create parallax between the level of the water and the marking. 

Water was allowed to flow out of the tube for a period of 90s for each height of water, this time was measured with a digital stopwatch. As the water flowed out it was caught in a large beaker so that the mass and volume of it could be measured after the allotted time had passed. 

The mass was found by having the beaker already on a set of electronic scales, and initially zeroed to account for the beaker's mass. The volume on the other hand required the water to be transferred from the beaker to a measuring cylinder, this was performed by using a pipette. Care was again taken so that there was no parallax and that no water remained within the beaker. It was also necessary to clear the tube once air bubbles formed within it, this reduced the flow rate of the water. The bubbles were cleared out using a long piece of copper wire. 

Three total sets of data were taken for each three of the capillary tubes, each tube varied in their internal diameter. The first tube had a diameter of 0.110cm, the next at 0.094cm, and the final tube of 0.093cm, these values were measured using a vernier scale in the horizontal direction, this was done multiple times to ensure an accurate value was taken.

The collected data was then fitted to a least square fitting to create an initial model, then chi-squared analysis was performed to check if our model would hold true and if our data was accurate. 
...
\begin{tabular}{ |c|c|c|c| } 
 ...
 \hline\hline
 $Blue$ &$0.55\pm0.03$ & $1.49\pm??$ & 19.0\\ 
 $Red$ & $0.47\pm0.03$ & $2.47\pm??$ & 6.01\\
 $Black$ & $0.46\pm0.03$ & $2.47\pm??$ & 27.0\\
